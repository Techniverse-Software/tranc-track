...
import { ViewGroupDetailsComponent } from "../../../partial/modals/view-group-details/view-group-details.component";
@Component({
  selector: "app-device-group",
  templateUrl: "./device-group.component.html",
  styleUrls: ["./device-group.component.scss"],
})
export class DeviceGroupComponent implements OnInit, AfterContentInit {
  ...
  delete(data) {
    ...
    this.modalRef.content.url = "userDeviceGroup/delete";
  ...
  viewGroup(data) {
    data.allDeviceDetails = Array.prototype.map
      .call(data.deviceDetails, (item) => {
        return item.id1;
      })
      .join(", ");
    data.allAssign = Array.prototype.map
      .call(data.groupDetails, (item) => {
        return item.name;
      })
      .join(", ");
    ...
    this.modalRef = this.modalService.show(ViewGroupDetailsComponent, {
      class: "modal-xl modal-dialog-centered ",
      initialState,
      backdrop: "static",
      keyboard: false,
