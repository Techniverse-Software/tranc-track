(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-dashboard-dashboard-module"], {
    ...
    function dU7(module, __webpack_exports__, __webpack_require__) {
      ...
      var _angular_google_maps__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
      /*! @angular/google-maps */
      "MIJf");
      /* harmony import */


      var ngx_tippy_wrapper__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ngx-tippy-wrapper */
      "xw+3");
      /* harmony import */


      var _partial_partial_module__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      ...
      var _dashboard_count_dashboard_count_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(
      /*! ./dashboard-count/dashboard-count.component */
      "IUv7");
      /* harmony import */
      ...
      var _map_view_map_view_component__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(
      /*! ./map-view/map-view.component */
      "H6Rb"); // import { TimeAgoPipe } from 'time-ago-pipe';
      ...
      DashboardModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        ...
        // TimeAgoPipe
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_4__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_12__["RouterModule"].forChild(route), _coreui_angular__WEBPACK_IMPORTED_MODULE_3__["TabsetModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_3__["CardModule"], _coreui_icons_angular__WEBPACK_IMPORTED_MODULE_5__["IconModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_3__["GridModule"], _angular_material_table__WEBPACK_IMPORTED_MODULE_8__["MatTableModule"], _angular_material_paginator__WEBPACK_IMPORTED_MODULE_6__["MatPaginatorModule"], _angular_material_sort__WEBPACK_IMPORTED_MODULE_7__["MatSortModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_3__["FormModule"], _angular_google_maps__WEBPACK_IMPORTED_MODULE_9__["GoogleMapsModule"], ngx_tippy_wrapper__WEBPACK_IMPORTED_MODULE_10__["NgxTippyModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_3__["SpinkitModule"], _partial_partial_module__WEBPACK_IMPORTED_MODULE_11__["PartialModule"]]
      })], DashboardModule);
      /***/
    },
    ...
    function o(module, __webpack_exports__, __webpack_require__) {
      ...
      var _raw_loader_table_view_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./table-view.component.html */
      "7P/b");
      /* harmony import */


      var _table_view_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _partial_modals_location_modal_location_modal_component__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(
      ...
      var _services_http_req_service__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(
      /*! ../../../services/http-req.service */
      "J+oG");
      /* harmony import */


      var _services_google_maps_loader_service__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(
      /*! ../../../services/google-maps-loader.service */
      "YAPy");
      /* harmony import */


      var _partial_pipe_location_pipe__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(
      /*! ../../../partial/pipe/location.pipe */
      "3J4n"); /// <reference types="googlemaps" />


      var TableViewComponent = /*#__PURE__*/function () {
        function TableViewComponent(httpReqService, authService, modalService, gmLoader, locationPipe) {
          ...
          this.field = ["userDetail.name", "organizationDetail.organizationName", "userDetail.email", "deviceDetail.location"];
        ...
        _createClass(TableViewComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.tokenData = this.authService.decodeToken(); // this.tokenData = tokenData1.user;

            if (this.tokenData && this.tokenData.user.organizationId) {
              this.displayedColumns = ["userDetail.name", "userDetail.email", "deviceDetail.location", "createdAt", "status"];
            } else {
              this.displayedColumns = ["userDetail.name", "organizationDetail.organizationName", "userDetail.email", "deviceDetail.location", "createdAt", "status"];
      ...
      TableViewComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function EHuJ(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function H6Rb(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      var _map_view_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var _partial_pipe_location_pipe__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(
      /*! ../../../partial/pipe/location.pipe */
      "3J4n");
      /* harmony import */


      var _services_google_maps_loader_service__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
      /*! ../../../services/google-maps-loader.service */
      "YAPy");
      /* harmony import */


      var _services_http_req_service__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(
      /*! ../../../services/http-req.service */
      "J+oG");
      /* harmony import */
      ...
      /*! ngx-socket-io */
      "RH9n"); /// <reference types="googlemaps" />


      var MapViewComponent = /*#__PURE__*/function () {
        function MapViewComponent(httpClient, gmLoader, authService, httpReqService, socket) {
        ...
        _createClass(MapViewComponent, [{
          ...
          value: function ngOnInit() {
            ...
            this.loading = true; // this.socket.on('message', (data)=>{
            //   console.log(data)
            // });
            // setInterval(()=>{
            ...
            setTimeout(function () {
              ...
              if (_this.tokenData.organizationId) {
                _this.getOrgDetail();
              }

              _this.getData();

              _this.interval = setInterval(function () {// this.getData();
              }, 10000);
            });
          }
        }, {
          ...
          value: function ngOnDestroy() {
            ...
            this.socket.removeListener("'mapview" + this.tokenData._id + "'", function (data) {});
            this.socket.removeListener("'mapview" + this.tokenData.organizationId + "'", function (data) {});
            this.socket.removeListener("mapview", function (data) {});
          }
        }, {
          key: "getOrgDetail",
          value: function getOrgDetail() {
                  ...
                  switch (_context3.prev = _context3.next) {
                    ...
                    case 3:
                      ...
                      if (response.items.length) {
                        ...
                        this.httpClient.get("assets/cities.json").subscribe(function (data) {
                          var city_object = data.filter(function (x) {
                            if (x.name == _this2.organizatioData.billingAddress.town) {
                              return true;
                            }
                          });

                          if (city_object && city_object[0]) {
                            _this2.map.setCenter({
                ...
                while (1) {
                  switch (_context4.prev = _context4.next) {
                    case 0:
                      ...
                      _context4.next = 4;
                      return this.httpReqService.post('scanHistory/map_view', obj, false);

                    case 4:
                      response = _context4.sent;
                      response.items.forEach(function (data) {
                        var index = _this3.history_list.findIndex(function (x) {
                          return x._id.toString() == data._id.toString();
                        });

                        if (index == -1) {
                          _this3.history_list.push(data);

                          _this3.add_marker(data);
                        }
                      });
                      ...
                      if (!this.is_socket) {
                        ...
                        if (response.type == 0) {
                          this.socket.on("'mapview" + this.tokenData.user._id + "'", function (data) {
                            _this3.getData();
                          });
                        } else if (response.type == 1) {
                          this.socket.on("mapview", function (data) {
                            _this3.getData();
                          });
                        } else if (response.type == 2) {
                          this.socket.on("'mapview" + this.tokenData.user.organizationId + "'", function (data) {
                            _this3.getData();
                          });
                        }
                      }
          ...
          key: "add_marker",
          value: function add_marker(data) {
            var _this4 = this;
            ...
            var contentString = '<label>Name: </label>' + data.userDetail.name + '<br> <label>Address: </label>' + data.installationLocation;
          ...
          key: "converTime",
          value: function converTime() {
            var d = new Date(); // get UTC time in msec

            var utc = d.getTime() + d.getTimezoneOffset() * 60000;
            var mapTime = this.organizatioData.mapFlushTime.split(':');
    ...
    /***/
    function IUv7(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "DashboardCountComponent", function () {
      ...
      var _raw_loader_dashboard_count_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./dashboard-count.component.html */
      "jBpl");
      /* harmony import */


      var _dashboard_count_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      /*! ./dashboard-count.component.scss */
      "EHuJ");
      /* harmony import */
      ...
      var DashboardCountComponent = /*#__PURE__*/function () {
        function DashboardCountComponent(httpReqService, authService) {
          _classCallCheck(this, DashboardCountComponent);
          ...
          this.countData = [{
            ...
            name: 'Total Registred Users',
            count: 5
          }, {
            name: 'Check-In This Month',
            count: 5
          }, {
            name: 'Check-In Since Start',
            count: 6
          }, {
            name: 'Number Of Organization',
            count: 7
          }, {
            name: 'Number Of Active Organization',
            count: 1
          }, {
            name: 'Number Of Resellers',
            count: 5
          }, {
            name: 'Number Of Active Resellers',
            count: 8
          }];
          this.loading = false;
        }

        _createClass(DashboardCountComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            var _this5 = this;
            ...
            this.getUserCount();
            setTimeout(function () {
              _this5.getPermissionDetails();
            }, 2000);
          }
        }, {
          key: "getPermissionDetails",
          value: function getPermissionDetails() {
                ...
                while (1) {
                  switch (_context5.prev = _context5.next) {
                    case 0:
                      this.loading = true;
                      _context5.next = 3;
                      return this.httpReqService.get('permission', this.tokenData.permissionId);
                ...
                while (1) {
                  switch (_context6.prev = _context6.next) {
                    case 0:
                      this.loading = true;
                      _context6.next = 3;
                      return this.httpReqService.post('dashboardCount/user', {
                        user_id: this.tokenData._id
                      }, false);
                ...
                while (1) {
                  switch (_context7.prev = _context7.next) {
                    case 0:
                      this.loading = true;
                      _context7.next = 3;
                      return this.httpReqService.post('dashboardCount/organization', {
                        user_id: this.tokenData._id
                      }, false);
      ...
      DashboardCountComponent.ctorParameters = function () {
        return [{
      ...
      DashboardCountComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    /***/
    function Qg7a(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function jBpl(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    function l70X(module, __webpack_exports__, __webpack_require__) {
      ...
      /*! ../../services/auth.service */
      "lGQG"); /// <reference types="googlemaps" />
    ...
    /***/
    function uNKX(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function vQfC(module, __webpack_exports__, __webpack_require__) {
      "use strict";
