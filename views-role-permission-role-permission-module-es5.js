(function () {
  ...
  (window["webpackJsonp"] = window["webpackJsonp"] || []).push([["views-role-permission-role-permission-module"], {
    ...
    /***/
    function n19(module, __webpack_exports__, __webpack_require__) {
      "use strict";
      ...
      __webpack_require__.d(__webpack_exports__, "RolePermissionComponent", function () {
      ...
      var _raw_loader_role_permission_component_html__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(
      /*! raw-loader!./role-permission.component.html */
      "YHT1");
      /* harmony import */


      var _role_permission_component_scss__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
      ...
      var RolePermissionComponent = /*#__PURE__*/function () {
        function RolePermissionComponent(httpReqService, fb, vf, router, route, gs) {
          _classCallCheck(this, RolePermissionComponent);
          ...
          this.roleArr = ['Admin', 'Super Admin', 'Scanner', 'Intaller', 'ScannerAndInstaller', 'Resellers', 'Organization Manager'];
          this.permissionArr = [{
            name: 'Add Device',
            slug: 'addDevice',
            checked: false
        ...
        _createClass(RolePermissionComponent, [{
          key: "ngOnInit",
          value: function ngOnInit() {
            this.createForm();
            this.formErrors = this.vf.errorMessages;
            this.allPermissionArr = this.permissionArr.map(function (a) {
              ...
              return regeneratorRuntime.wrap(function _callee$(_context) {
                while (1) {
                  switch (_context.prev = _context.next) {
                    case 0:
                      this.permissionArr = this.allPermissionArr.map(function (a) {
                        return Object.assign({}, a);
                      });
                      _context.next = 3;
                      return this.httpReqService.post('rolePermission/roleWiseGetPermission', this.permissionForm.value, false);
                    ...
                    case 3:
                      ...
                      if (response && response.items) {
                        ...
                        if (this.permissionList.length) {
                          this.permissionArr.forEach(function (permission, i) {
                            if (_this.permissionList.includes(permission.slug)) {
          ...
          key: "changeCheckbox",
          value: function changeCheckbox(permission) {
                    ...
                    case 0:
                      ...
                      this.permissionArr.forEach(function (permission, i) {
                        if (permission.checked) {
                          _this2.permissions.push(permission.slug);
                        }
                      });
                      obj = {
                      ...
                      _context2.next = 6;
                      return this.httpReqService.post('rolePermission/create', obj, true);
      ...
      RolePermissionComponent.ctorParameters = function () {
        return [{
      ...
      RolePermissionComponent = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
    ...
    function YM(module, __webpack_exports__, __webpack_require__) {
      ...
      var _role_permission_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(
      ...
      RolePermissionModule = Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [_role_permission_component__WEBPACK_IMPORTED_MODULE_3__["RolePermissionComponent"]],
        imports: [_angular_common__WEBPACK_IMPORTED_MODULE_2__["CommonModule"], _angular_router__WEBPACK_IMPORTED_MODULE_4__["RouterModule"].forChild(route), _coreui_angular__WEBPACK_IMPORTED_MODULE_5__["CardModule"], _coreui_icons_angular__WEBPACK_IMPORTED_MODULE_6__["IconModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_5__["GridModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_5__["ButtonModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["ReactiveFormsModule"], _coreui_angular__WEBPACK_IMPORTED_MODULE_5__["FormModule"]]
    ...
    /***/
    function YHT1(module, __webpack_exports__, __webpack_require__) {
      "use strict";
    ...
    /***/
    function lWQV(module, __webpack_exports__, __webpack_require__) {
      "use strict";
